/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d9cc53be90000973e7aab5f29df734e2)
// Runtime types generated with workerd@1.20260301.1 2025-02-01 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "WorldDurableObject";
	}
	interface Env {
		ENVIRONMENT: "production";
		WORLD_ID: "silver-clouds-now";
		CORS_ORIGINS: "https://thesecretsofsilverclouds.com,https://www.thesecretsofsilverclouds.com,http://127.0.0.1:4317,http://127.0.0.1:4322,http://localhost:8787";
		WORLD_DO: DurableObjectNamespace<import("./src/worker").WorldDurableObject>;
	}
}
