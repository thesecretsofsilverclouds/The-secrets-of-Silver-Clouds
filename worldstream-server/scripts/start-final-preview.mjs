...
const directory=join(root,'data','worldstream-final-review-v21');
...
server.listen(4322,'127.0.0.1',()=>console.log('Worldstream final review: http://127.0.0.1:4322/ · saved London-clock world · authored scenes · model calls disabled'));
