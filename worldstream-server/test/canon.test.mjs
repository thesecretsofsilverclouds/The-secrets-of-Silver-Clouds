...
test('a publicly visible event teaches Goaden and Ashai nothing by itself', t => {
  ...
  const acquisitions = new Set(['NOTICE_PUBLIC_FACT', 'SHARE_PRACTICAL_FACT', 'DEFER_ACTIVITY', 'PRACTICE_END', 'GAME_PAUSE',
    ...
    'AGENDA_REPORT_READ', 'MEU_REPORT_READ', 'LEGION_JOB_HANDOFF_READ',
    'LEGION_JOB_OFFER', 'LEGION_JOB_ACCEPT', 'LEGION_JOB_START', 'LEGION_JOB_REPORT',
    'LEGION_JOB_RESOLVE', 'LEGION_JOB_PAYMENT', 'LEGION_JOB_CLOSE',
    'GROUND_PREPARED', 'GROUND_WORK_COMPLETED',
