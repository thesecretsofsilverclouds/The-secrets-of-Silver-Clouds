...
export function upgradeMeuCases({ directory, backupPath } = {}) {
  ...
  if (![TO, 'canon-ambient-p183-v25', 'canon-ambient-p183-v26', 'canon-ambient-p183-v27', 'canon-ambient-p183-v28', 'canon-ambient-p183-v29', 'canon-ambient-p183-v30'].includes(RULES_VERSION)) throw new Error('This upgrade belongs to release v24 or later');
